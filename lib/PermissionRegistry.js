...
function PermissionRegistry(securityRegistry) {
  ...
  this.getPermission = function(permissionName, resource, role, cb) {
    ...
    if (_.isString(permissionName) === false) {
      throw new Errors.PermissionArchitectPermissionRegistryError('Expected permissionName to be of type String');
    }
    if (typeof(resource) !== 'object') {
      throw new Errors.PermissionArchitectPermissionRegistryError('Expected resource to be type of Object');
    }
    if (typeof(role) !== 'object') {
      throw new Errors.PermissionArchitectPermissionRegistryError('Expected role to be type of Object');
    }
